            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {data.records.map((r) => (
                  ...
                  >
                    <td className="py-3 pr-4 text-slate-300 max-w-[180px] truncate">
                      {r.notes ?? "—"}
                    </td>
                    ...
                    <td
                      className={`py-3 pr-4 font-medium whitespace-nowrap ${r.type === "income" ? "text-emerald-400" : "text-red-400"}`}
                    >
                      {r.type === "income" ? "+" : "−"}
                    ...
                    {isAdmin && (
                      <td className="py-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            onClick={() => openEdit(r)}
                            className="text-xs text-slate-500 hover:text-indigo-400 transition-colors px-2 py-1 rounded hover:bg-dark-600"
                          >
                            Edit
                          </button>
                          <button
                            onClick={() => handleDelete(r.id)}
                            className="text-xs text-slate-500 hover:text-red-400 transition-colors px-2 py-1 rounded hover:bg-dark-600"
                          >
                            Delete
                          </button>
                        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. April salary credit"
              />
            </div>
